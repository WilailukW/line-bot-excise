...
$ACCESS_TOKEN = 'SzMza80t/nzEEeJZpy/poMUvlLAC0ix9bvYcma2m7LCWoOKKNX46ngRr7A0KIJBTwBbd/y0SfoJTlGvR20ed/psjgxQlSP0A01YdZus4CNbKRBxsMVV7uwT2+AoxtFsG6LVKBNcIZlevC9HJT7UAAwdB04t89/1O/w1cDnyilFU='; // Access Token ค่าที่เราสร้างขึ้น
  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
	   ...
	   if($text == "ตื่นรึยังบอท"){
		   $reply_message = 'ตื่นแล้ว! พร้อมให้บริการเจ้าค่ะ...';
	   }
	  ...
	  if($text == "อุณหภูมิตอนนี้" || $text == "อุณหภูมิขณะนี้" || $text == "อุณหภูมิขณะนี้เท่าไหร่" || $text == "อุณหภูมิขณะนี้กี่องศา"){
